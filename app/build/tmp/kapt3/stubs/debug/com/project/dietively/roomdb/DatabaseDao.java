...
public abstract interface DatabaseDao {
    ...
    @androidx.room.Insert(onConflict = 1)
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object insertMenstrualDays(@org.jetbrains.annotations.NotNull()
    com.project.dietively.roomdb.MenstrualDays data, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> $completion);
    
    @androidx.room.Query(value = "SELECT * FROM menstrual_day_data")
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.util.List<com.project.dietively.roomdb.MenstrualDays>> getMenstrualDays();
}